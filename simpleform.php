...
if ($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  {
    $friend_to_update = updateFriend($_POST['name'], $_POST['major'], $_POST['year']);
    $list_of_friends = getAllFriends();
  }
...
<form name="mainForm" action="simpleform.php" method="post">   
  ...
  <div class="row mb-3 mx-3">
    Year:
    <input type="number" max="4" min="1" class="form-control" name="year" required value="<?php if($friend_to_update!=null) echo $friend_to_update['year']; ?>"/>            
  </div>   
  <!-- <div class="row mb-3 mx-3">     -->
  <div>
...
<?php foreach ($list_of_friends as $friend_info): ?>
  <tr> 
     ...
     <td><form action="simpleform.php" method="post">
          ...
          <input type="hidden" name="friend_to_delete" value="<?php echo $friend_info['name']; ?>"/>
        </form>
    </td>            
  </tr>
<?php endforeach; ?>
